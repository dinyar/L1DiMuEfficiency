...
effHistList = []
effHistList.append(["mu1_recoEta", 100, -2.8, 2.8, "Eta1_reco", cutDict["diMu-gmtPt1"], cutDict["diMu-recoPt1"], stackCutDict["subsystems_mu1"]])
effHistList.append(["mu2_recoEta", 100, -2.8, 2.8, "Eta2_reco", cutDict["diMu-gmtPt1"], cutDict["diMu-recoPt1"], stackCutDict["subsystems_mu2"]])
effHistList.append(["mu1_recoPhi", 100, -3.2, 3.2, "Phi1_reco", cutDict["diMu-gmtPt1"], cutDict["diMu-recoPt1"], stackCutDict["subsystems_mu1"]])
effHistList.append(["mu2_recoPhi", 100, -3.2, 3.2, "Phi2_reco", cutDict["diMu-gmtPt1"], cutDict["diMu-recoPt1"], stackCutDict["subsystems_mu2"]])
effHistList.append(["mu1_recoPt", 100, 0, 100, "pT1_reco", cutDict["diMu-gmtPt1"], cutDict["diMu-recoPt1"], stackCutDict["subsystems_mu1"]])
effHistList.append(["mu2_recoPt", 100, 0, 100, "pT2_reco", cutDict["diMu-gmtPt1"], cutDict["diMu-recoPt1"], stackCutDict["subsystems_mu2"]])
