...
void diMuRates(const char * fname="file_list_275125", TString folder="tmp", TString run="XXX", int mu1cut = 11, int mu2cut = 4){
  ...
  TH1D* muGhostRatesUnpack = new TH1D("muGhostRatesUnpack", "", nMuBins, muLo-0.1, muHi+0.1);
  TH1D* muGhostRatesReEmu = new TH1D("muGhostRatesReEmu", "", nMuBins, muLo-0.1, muHi+0.1);
  TH1D* muGhostRatesOpenUnpack = new TH1D("muGhostRatesOpenUnpack", "", nMuBins, muLo-0.1, muHi+0.1);
  TH1D* muGhostRatesOpenReEmu = new TH1D("muGhostRatesOpenReEmu", "", nMuBins, muLo-0.1, muHi+0.1);
  TH1D* muGhostRatesOpenTrailingUnpack = new TH1D("muGhostRatesOpenTrailingUnpack", "", nMuBins, muLo-0.1, muHi+0.1);
  TH1D* muGhostRatesOpenTrailingReEmu = new TH1D("muGhostRatesOpenTrailingReEmu", "", nMuBins, muLo-0.1, muHi+0.1);
